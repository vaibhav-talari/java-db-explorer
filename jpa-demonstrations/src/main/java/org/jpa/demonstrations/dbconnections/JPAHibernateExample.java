...
public class JPAHibernateExample extends DBOperationsJPA {

	private static Logger logger = LoggerFactory.getLogger(JPAHibernateExample.class);

	public JPAHibernateExample() {
		createEntityFactory();
	}
	...
	public void createEntityFactory() {
		...
		// persistent.xml
		entityManagerFactory = Persistence.createEntityManagerFactory("jpa-default");
